...
export function AccountExperience() {
  ...
  async function submitPayment(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      const response = await fetch("/api/payments", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ predictionId: data.get("predictionId"), method: data.get("method"), transactionReference: data.get("transactionReference") || undefined, idempotencyKey: crypto.randomUUID() }) });
