  ...
  if (branch === "science") {
    if (pct >= 84) {
      teasers.push({
        id: "science-high",
        question: scoreText
          ? `هل مجموعك (${scoreText}) يدخلك حاسبات ومعلومات أو ذكاء اصطناعي في المرحلة الثانية؟`
          : "هل مجموعك يؤهلك لكليات الحاسبات ومعلومات والذكاء الاصطناعي في المرحلة الثانية؟",
        categoryTag: "تحليل كليات القمة والمرحلة الثانية",
        badgeText: "متاح في التقرير 🔒",
      });
    } else if (pct >= 70) {
      teasers.push({
      ...
      teasers.push({
        ...
        question: scoreText
          ...
          : "الكليات الحكومية والمعاهد المعتمدة المتبقية لمجموعك في المرحلة الثانية",
