...
export function generateSmartLockedTeasers({
    ...
    return [
      {
        id: "stage3-vacancies",
        question: scoreText
          ? `ما هي الكليات الحكومية المتاحة رسميًا في المرحلة الثالثة والأقرب لمجموعك (${scoreText})؟`
          : "ما هي الكليات الحكومية المتاحة رسميًا في المرحلة الثالثة والأقرب لمجموعك؟",
        categoryTag: "شواغر المرحلة الثالثة الرسمية",
      ...
      {
        id: "stage3-safety",
        question: "كيف ترتب رغباتك في المرحلة الثالثة لتفادي استنفاد الرغبات وتقليل مخاطر عدم القبول؟",
  ...
  if (branch === "science") {
    ...
    if (pct >= 72) {
      ...
      teasers.push({
        ...
        question: scoreText
          ...
          : "مدى ملاءمة كليات التربية والآداب والحقوق لمجموعك",
    ...
    teasers.push({
      id: "generic-score",
      question: scoreText
        ? `ما هي أنسب وأقرب الكليات الحكومية لمجموعك (${scoreText})؟`
        : "ما هي أنسب وأقرب الكليات الحكومية لمجموعك؟",
      categoryTag: "تحليل المجموع والملاءمة",
      badgeText: "متاح في التقرير 🔒",
    });
  }
  ...
  if (govText) {
    ...
    teasers.push({
      id: "geo-general",
      question: "ما هي أقرب الكليات لمحافظتك ونطاقك الجغرافي (أ) و (ب) والأنسب لمجموعك؟",
  ...
  teasers.push({
    ...
    question: scoreText
      ...
      : "ترتيب مقترح لـ 75 رغبة لتفادي استنفاد الرغبات وتحسين فرص الاختيار",
