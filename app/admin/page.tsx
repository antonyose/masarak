...
type Payment = { id: string; userName: string | null; userEmail: string | null; studentName: string | null; seatNumber: string; method: string; expectedAmount: string; senderIdentifier: string; transactionReference: string | null; submittedAt: string; hasReceipt: boolean };
